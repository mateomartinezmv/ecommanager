...
// POST /api/shopify/sync-stock → empuja stock del CRM a Shopify
...
module.exports = async (req, res) => {
  ...
  try {
    ...
    // Obtener productos con shopify_id
    ...
    // Obtener location_id desde inventory_levels de un item conocido
    ...
    if (!firstInventoryItemId) throw new Error('No se pudo obtener inventory_item_id del primer producto');

    // Obtener location_id desde inventory_levels de ese item
    ...
    if (!locationId) throw new Error('No se encontró location_id. Respuesta: ' + JSON.stringify(levelsData));
